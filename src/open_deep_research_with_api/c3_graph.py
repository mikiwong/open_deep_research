...
from src.open_deep_research_with_api.c3_prompts import (
...
def get_sentiment(
    ...
    """Call to get our sentiment of a country"""
    if country.lower() in ["singapore"]:
        mock_api_results = {"sentiment": 10, "country": country}
    else:
